...
Ver la sección "Próximos pasos sugeridos" al final de `docs/GAME_DESIGN.md`: arte final (reemplazar la geometría gris de las fábricas de objetos), SFX/música, testeo con no-gamers, y feature de compartir resultado como imagen.
